...
<head runat="server" >
    ...
    $.extend($.fn.combobox.defaults, {panelHeight:true});
        var me = {
            ...
            search_form: null,
            search_window: null,
            idFiled: 'TemperatureID',
            actionUrl: 'TemperatureCommon.ashx'
        };
        ...
        function loadGrid() {
            me.datagrid1.datagrid({
                ...
                columns: [[
                  ...
                  { field: 'OverrunsTime', title: '超限时间', width: 140, sortable: true, align: 'center' },
                  { field: 'OverrunsTemperature', title: '超限温度(℃)', width: 80, sortable: true, align: 'center' },
                  { field: 'RecoveryTime', title: '恢复时间', width: 140, sortable: true, align: 'center' },
                  { field: 'RecoveryTemperature', title: '恢复温度(℃)', width: 80, sortable: true, align: 'center' }
                ]],
