    ...
    $.extend($.fn.combobox.defaults, {panelHeight:true});
        ...
        function loadGrid() {
            me.datagrid1.datagrid({
                sortName: me.idFiled,
                idField: me.idFiled,
                url: me.actionUrl + '?Method=OpenTheDoorToRecord_List',
                frozenColumns: [[
                ...
                columns: [[
                  ...
                  { field: 'OpenTime', title: '开门时间', width: 140, sortable: true, align: 'center' },
                  { field: 'CloseTime', title: '关门时间', width: 140, sortable: true, align: 'center' }
                ]],
