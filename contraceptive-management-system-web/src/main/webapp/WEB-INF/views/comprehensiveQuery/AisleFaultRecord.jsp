    ...
    $.extend($.fn.combobox.defaults, {panelHeight:true});
        ...
        function loadGrid() {
            me.datagrid1.datagrid({
                sortName: me.idFiled,
                idField: me.idFiled,
                url: me.actionUrl + '?Method=AisleFaultRecord_List',
                frozenColumns: [[
                ...
                columns: [[
                  ...
                  { field: 'FaultCargoRoad', title: '缺道号', width: 60, sortable: true, align: 'center' },
                  { field: 'FaultTime', title: '故障时间', width: 140, sortable: true, align: 'center' },
