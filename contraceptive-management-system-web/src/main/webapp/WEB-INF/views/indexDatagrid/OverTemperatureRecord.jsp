...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html">
	<head>
	 ...
	 function submitForm(){
    		...
    		params.endTime = $("#endTime").datetimebox("getValue").length==0?-1:$("#endTime").datetimebox("getValue");
          	...
          	$('#dg').datagrid({
          		url: 'getOverTemperatureRecordSearchArea',
          		queryParams:params
          	});
          }
	...
	<body style="margin: 0px;padding: 0px;" class="easyui-layout">
		...
		<div data-options="region:'north',title:'条件查询',split:true" style="height:100px;text-align:left;padding:20px;" align="center">
			 <form id="form" method="post">  
			   ...
			   <jsp:include page="../base/areaSearch.jsp" />
			    超温时间自：<input id="startTime" class="easyui-datetimebox" name="birthday" data-options=""  style="width:90px"/>
		 ...
		 <table id="dg" class="easyui-datagrid" style="width: 570px;height: 250px;"
				data-options="onLoadSuccess:selectOneLine,striped:true,fit:true,loadMsg:'加载中，请稍后...',pageList:[5,10,15],pagination:true,url:'getOverTemperatureRecordSearchArea',singleSelect:true,pageSize:10">
			<thead frozen="true">
				<tr>
			...
			<thead>
				<tr>
					...
					<th field="overTemperatureDate" align="center" data-options="sortable:true,fixed:true,width:160">超限时间</th>
					<th field="overTemperature" align="center" data-options="sortable:true,fixed:true,width:80">超限温度（℃）</th>
					<th field="recoveryDate" align="center" data-options="sortable:true,fixed:true,width:160">恢复时间</th>
					<th field="recoveryTemperature" align="center" data-options="fixed:true,width:80">恢复温度（℃）</th>
				</tr>
			</thead>
		</table>
	</div>
