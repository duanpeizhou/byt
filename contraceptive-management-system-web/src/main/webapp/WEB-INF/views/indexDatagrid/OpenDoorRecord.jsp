		...
		<div data-options="region:'north',title:'条件查询',split:true" style="height:80px;text-align:left;padding:10px;" align="center">
			 <form id="form" method="post">  
			   ...
			   <jsp:include page="../base/areaSearch.jsp" />
			    开门时间自：<input id="startTime" class="easyui-datetimebox" name="birthday" data-options=""  style="width:90px"/>
		 ...
		 <table id="dg" class="easyui-datagrid" style="width: 570px;height: 250px;"
				data-options="onLoadSuccess:selectOneLine,striped:true,fit:true,loadMsg:'加载中，请稍后...',pageList:[10,25,50],pagination:true,url:'openDoorRecordSearchArea',singleSelect:true,pageSize:10">
			<thead frozen="true">
				<tr>
			...
			<thead>
				<tr>
					...
					<th field="openDoorDate" align="center" data-options="sortable:true,fixed:true,width:160">开门时间</th>
					<th field="closeDoorDate" align="center" data-options="sortable:true,fixed:true,width:160">关门时间</th>
				</tr>
			</thead>
		</table>
	</div>
