	...
	<body style="margin: 0px;padding: 0px;" class="easyui-layout">
		...
		<div data-options="region:'north',title:'条件查询',split:true" style="height:80px;text-align:left;padding:10px;" align="center">
		 ...
		 <table id="dg" class="easyui-datagrid" style="width: 570px;height: 250px;"
				data-options="onLoadSuccess:selectOneLine,striped:true,rownumbers:true,fit:true,loadMsg:'加载中，请稍后...',pageList:[5,10,15,50],pagination:true,url:'offline3SearchArea',singleSelect:true,pageSize:50">
			<thead>
				<tr>
					...
					<th field="area.name" data-options="width:100,fixed:true,formatter:communityArea2">社区</th>
