	    ...
	    <link href="css/default.css" rel="stylesheet" type="text/css" />
	     <script src="js/commonJS1.js" type="text/javascript"></script>
	      ...
	      $.extend($.fn.combobox.defaults, {panelHeight:true});
            ...
            function overTemperatureDateFormatter(value,row,index){
            	if(row.machineryEquipmentState.overTemperatureDate){
            		return row.machineryEquipmentState.overTemperatureDate;
            	}
            }
            /*
        		定时刷新数据
        	...
        	function refreshDatagrid(){
	   			$('#dg').datagrid({
	   				reload:"overTemperatureSearchArea"
	   			});
     		}
	...
	<body style="margin: 0px;padding: 0px;" class="easyui-layout">
		...
		<div data-options="region:'north',title:'条件查询',split:true" style="height:80px;text-align:left;padding:10px;" align="center">
		 ...
		 <table id="dg" class="easyui-datagrid" style="width: 570px;height: 250px;"
				data-options="onLoadSuccess:selectOneLine,striped:true,rownumbers:true,fit:true,loadMsg:'加载中，请稍后...',pageList:[10,25,40,50],pagination:true,url:'overTemperatureSearchArea',singleSelect:true,pageSize:25">
			<thead frozen="true">
				<tr>
			...
			<thead>
				<tr>
					...
					<th field="machineryEquipmentState.overTemperatureDate" data-options="align:'center',formatter:overTemperatureDateFormatter,sortable:true,align: 'center',fixed:true,width:160">超限时间</th>
					<th field="machineryEquipmentState.deviceTemperature" data-options="align:'center',formatter:deviceTemperatureFormatter,sortable:true">当前设备温度（℃）</th>
