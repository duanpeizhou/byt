	 ...
	 function downloadData(){
		...
		endTime = $("#endTime").datetimebox("getValue").length==0?-1:$("#endTime").datetimebox("getValue");
     	communityId = $("#community").combobox('getValue') != "全部"
				&& $("#community").combobox('getValue') > 0 ? $(
				"#community").combobox('getValue') : -1;
			$("<iframe src='onlineOfflineRecordSearchArea/export?cityId="+'<spring:message code="City.no"/>'+"&startTime="+startTime+"&endTime="+endTime
		...
		<div data-options="region:'north',title:'条件查询',split:true" style="height:80px;text-align:left;padding:10px;" align="center">
			 <form id="form" method="post">  
			   ...
			   <jsp:include page="../base/areaSearch.jsp" />
			    上线时间自：<input id="startTime" class="easyui-datetimebox" name="birthday" data-options=""  style="width:90px"/>
		 ...
		 <table id="dg" class="easyui-datagrid" style="width: 570px;height: 250px;"
				data-options="onLoadSuccess:selectOneLine,striped:true,fit:true,loadMsg:'加载中，请稍后...',pageList:[10,20,30,50,100],pagination:true,url:'onlineOfflineRecordSearchArea',singleSelect:true,pageSize:30">
			<thead frozen="true">
				<tr>
			...
			<thead>
				<tr>
					...
					<th field="onlineDate" align="center" data-options="sortable:true,fixed:true,width:160">上线时间</th>
					<th field="offlineDate" align="center" data-options="sortable:true,fixed:true,width:160">下线时间</th>
				</tr>
			</thead>
		</table>
	</div>
