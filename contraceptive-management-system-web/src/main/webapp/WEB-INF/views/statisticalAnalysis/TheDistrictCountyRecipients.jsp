    ...
    <script type="text/javascript">
        ...
        function chart() {
            $.ajax({
                sortName: me.idFiled,
                idField: me.idFiled,
                url: me.actionUrl + '?Method=TheDistrictCountyRecipients_Chart',
                type: 'POST',
                dataType: "html",
        ...
        function loadGrid() {
            me.datagrid1.datagrid({
                sortName: me.idFiled,
                idField: me.idFiled,
                url: me.actionUrl + '?Method=TheDistrictCountyRecipients_List',
                frozenColumns: [[
                  { field: 'Name', title: '区县', width: 90, sortable: true, align: 'center' }
                  ]],
                columns: [[
