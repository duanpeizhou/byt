    ...
    <script type="text/javascript">
        ...
        function chart() {
            $.ajax({
                sortName: me.idFiled,
                idField: me.idFiled,
                url: me.actionUrl + '?Method=AgeStructureOfRecipients_Chart',
                type: 'POST',
                dataType: "html",
        ...
        function loadGrid() {
            me.datagrid1.datagrid({
                sortName: me.idFiled,
                idField: me.idFiled,
                url: me.actionUrl + '?Method=AgeStructureOfRecipients_List',
                frozenColumns: [[
                  { field: 'AgeName', title: '年龄段', width: 100, sortable: true, align: 'center' }
                  ]],
                columns: [[
